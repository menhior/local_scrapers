...
for i in range(1, 7):
    ...
    url = 'https://oneclick.az/business/clothing-accessories/Bijouterie/Bijuteriya?city=784&hl=ru&page=' + str(i)
...
df.to_excel(r'Scraped.xlsx', sheet_name='OneClick', index=False)
